...
export const CheckoutSidebar = ({ total, onPurchase, isCanceled, isPending }: CheckoutSidebarProps) => {
        return (
                <div className="border rounded-md outline-hidden bg-white flex flex-col">
